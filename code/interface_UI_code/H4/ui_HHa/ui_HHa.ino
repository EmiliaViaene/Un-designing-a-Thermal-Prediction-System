...
void gisteren_setdatelabels(lv_event_t * e) {
  String serverPath = "http://data.id.tue.nl/datasets/downloadPublic/json/Ump2bDJqKzh5aC8vSlBnT2wxakpiLzNlTC9HSkh3TGhPV25FeFFIOVU4dz0=";
  ...
  for (int i = 0; i < 24; i++) {
    ...
    lv_chart_series_t * ui_GISTEREN_CHART_LIVING_GORDIJN_series_1 = lv_chart_get_series_next(ui_GISTEREN_CHART_LIVING_GORDIJN, NULL);
    lv_chart_set_next_value(ui_GISTEREN_CHART_LIVING_GORDIJN, ui_GISTEREN_CHART_LIVING_GORDIJN_series_1, (double) myObject[i]["curtain_living"]);
    lv_chart_series_t * ui_GISTEREN_CHART_LIVING_SCHADUW_series_1 = lv_chart_get_series_next(ui_GISTEREN_CHART_LIVING_SCHADUW, NULL);
    lv_chart_set_next_value(ui_GISTEREN_CHART_LIVING_SCHADUW, ui_GISTEREN_CHART_LIVING_SCHADUW_series_1, (double) myObject[i]["shade_living"]);
    lv_chart_series_t * ui_GISTEREN_CHART_ZITHOEK_GORDIJN_series_1 = lv_chart_get_series_next(ui_GISTEREN_CHART_ZITHOEK_GORDIJN, NULL);
    lv_chart_set_next_value(ui_GISTEREN_CHART_ZITHOEK_GORDIJN, ui_GISTEREN_CHART_ZITHOEK_GORDIJN_series_1, (double) myObject[i]["curtain_zithoek"]);
    lv_chart_series_t * ui_GISTEREN_CHART_ZITHOEK_SCHADUW_series_1_array = lv_chart_get_series_next(ui_GISTEREN_CHART_ZITHOEK_SCHADUW, NULL);
    lv_chart_set_next_value(ui_GISTEREN_CHART_ZITHOEK_SCHADUW, ui_GISTEREN_CHART_ZITHOEK_SCHADUW_series_1_array, (double) myObject[i]["shade_zithoek"]);
    lv_chart_series_t * ui_GISTEREN_CHART_ZITHOEK_DEUR_series_1 = lv_chart_get_series_next(ui_GISTEREN_CHART_ZITHOEK_DEUR, NULL);
    lv_chart_set_next_value(ui_GISTEREN_CHART_ZITHOEK_DEUR, ui_GISTEREN_CHART_ZITHOEK_DEUR_series_1, (double) myObject[i]["windowdoor_zithoek"]);
    lv_chart_series_t * ui_GISTEREN_CHART_KEUKEN_SCHADUW_series_1 = lv_chart_get_series_next(ui_GISTEREN_CHART_KEUKEN_SCHADUW, NULL);
    lv_chart_set_next_value(ui_GISTEREN_CHART_KEUKEN_SCHADUW, ui_GISTEREN_CHART_KEUKEN_SCHADUW_series_1, (double) myObject[i]["shade_keuken"]);
    lv_chart_series_t * ui_GISTEREN_CHART_KEUKEN_DEUR_series_1 = lv_chart_get_series_next(ui_GISTEREN_CHART_KEUKEN_DEUR, NULL);
    lv_chart_set_next_value(ui_GISTEREN_CHART_KEUKEN_DEUR, ui_GISTEREN_CHART_KEUKEN_DEUR_series_1, (double) myObject[i]["windowdoor_keuken"]);
  }
}

///////////////////////////////////////////////////////////////////// set values for three days ago /////////////////////////////////////////////////////////////////////
void gisteren_setvalues_1(lv_event_t * e) {
  String serverPath = "http://data.id.tue.nl/datasets/downloadPublic/json/ZXBSYTN1a0xzdC9Cd2w4bERGMm5rWkhWZmJzWFhFcXJVVkpFWFZpWEdpQT0=";
  JSONVar myObject = JSON.parse(httpGETRequest(serverPath.c_str()));
  // JSON.typeof(jsonVar) can be used to get the type of the var
  if (JSON.typeof(myObject) == "undefined") {
    Serial.println("Parsing input failed!");
...
void gisteren_setvalues_2(lv_event_t * e) {
  // lv_refr_now(NULL);
  String serverPath = "http://data.id.tue.nl/datasets/downloadPublic/json/bjVPa1RPcmR5S3Z4VmNlWU5ySm93YlJZY3FNUmllRlJIMTVrNlRXYThJYz0=";
  JSONVar myObject = JSON.parse(httpGETRequest(serverPath.c_str()));
  // JSON.typeof(jsonVar) can be used to get the type of the var
  if (JSON.typeof(myObject) == "undefined") {
    Serial.println("Parsing input failed!");
...
void gisteren_setvalues_3(lv_event_t * e) {
  String serverPath = "http://data.id.tue.nl/datasets/downloadPublic/json/WnJtQi8veXJrM280NnBEVTFDZ09pRGliWW5XNUd2V0NHNjYrbk0yUGZxST0=";
  JSONVar myObject = JSON.parse(httpGETRequest(serverPath.c_str()));
  // JSON.typeof(jsonVar) can be used to get the type of the var
  if (JSON.typeof(myObject) == "undefined") {
    Serial.println("Parsing input failed!");
