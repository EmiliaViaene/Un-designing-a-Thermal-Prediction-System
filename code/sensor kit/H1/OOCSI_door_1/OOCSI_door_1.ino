...
const char* OOCSIName = "HH1_door_1";
...
////////////////////////////////////////////////////////////// SLEEP TIMER
const uint32_t SLEEP_DURATION = 600 * 1000000; // 10*60=600(I want one reading per 10 minutes, taking into account delays etc.)
// ESP32 boot count
...
void loop() {
  ...
  oocsi.newMessage("HH_door_receiver");
  // replace DEVICE with your reference ID from a device
  oocsi.addString("device_id", "df7999d2d53c9442a");
