...
const char* OOCSIName = "HHa_indoor_data";
...
void processOOCSI() {
  ...
  if (Temperature_HH3 > -30.0) { // only return the temperature if its value is not rogue & specify which household I want the data from
...
void loop() { 
  ...
  oocsi.addString("participant", "H4");
